...
// Required normalizing of input so that our mobileNetv2 TorchScript model can work with it
// https://github.com/python-engineer/ml-deployment/blob/main/pytorch-ios/PyTorch%20Demo/PyTorch%20Demo/CVPixelBuffer%2BHelper.swift
